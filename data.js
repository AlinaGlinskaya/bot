module.exports = {
	...
	testQuestions: {
		'1': 'Вопрос 1 из 10. Кто из этих персонажей не получил высшие баллы по всем 12 предметам на СОВ?',
		'2': 'Вопрос 2 из 10. Сборные каких стран играли в финале Чемпионата мира по квиддичу в «Кубке Огня»?',
		'3': 'Вопрос 3 из 10. Какой Патронус у Чжоу Чанг?',
		'4': 'Вопрос 4 из 10. Кого из этих персонажей не пытали Круциатусом?',
		'5': 'Вопрос 5 из 10. Что из этого не входит в состав Оборотного зелья?',
		'6': 'Вопрос 6 из 10. Кто из этих персонажей не был игроком в квиддич?',
		'7': 'Вопрос 7 из 10. Как звали брата и сестру Дамблдора?',
		'8': 'Вопрос 8 из 10. Когда семеро Поттеров поднялись в ночное небо и отправились в «Нору», как Пожиратели Смерти узнали, какой из Поттеров — настоящий?',
		'9': 'Вопрос 9 из 10. Торт в форме чего испекла миссис Уизли для Гарри в честь его совершеннолетия?',
		'10': 'Вопрос 10 из 10. Кто из этих персонажей никогда не уничтожал крестраж?'
	},
